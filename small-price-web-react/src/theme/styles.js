...
export const inputStyles = {
  ...
  modalInput: "h-11 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-950 outline-none transition placeholder:text-slate-400 focus:border-slate-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:border-slate-500",
}
...
export const loginStyles = {
  ...
  modalPanel: "relative w-full max-w-md overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900",
  modalAccent: "absolute inset-x-0 top-0 h-1 bg-slate-950 dark:bg-slate-100",
  ...
  testCredential: "font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200",
